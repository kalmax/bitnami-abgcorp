<?php
/**
 * Plugin Name: Elementor Posts Carousel
 * Description: A simple Elementor Widget that creates carousel based on posts
...
add_action( 'elementor/widgets/widgets_registered', function() {
  ...
  $drop_down_widget = new Posts_Carousel_Widget();
